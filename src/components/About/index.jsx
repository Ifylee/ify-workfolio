    ...
    return (
      ...
      <section className="my-5">
        <div className="my-2">
          ...
          <p>
          Who could have imagined I’d become a coder? Born and raised in Nigeria, I earned my degree in French and began a rewarding career as a Sales Manager for an underwater engineering company. This role took me to Taiwan, Switzerland, France, and Germany, blending professional growth with adventure. </p>
          <p>
          In 2017, a trip to America transformed my life. I fell in love, got married, and began a new chapter as a wife. My career flourished as I transitioned to customer service, quickly earning a promotion to Shipping Supervisor within three months.</p>
         <p>
         During maternity leave, I stumbled upon an ad for Codecademy, igniting my journey into coding. I’ll never forget writing my first line of code—"Hello, world." It felt magical, as if I were conjuring something extraordinary. That moment sparked an unquenchable passion for creating and problem-solving. All I wanted to do was code!</p>
          <p>
